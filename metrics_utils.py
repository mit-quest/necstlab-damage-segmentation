...
from segmentation_models.base import Metric as MetricSM, KerasObject, functional
import numpy as np
...
class ClassBinaryAccuracy(MetricSM):
    r"""
    ...
    def __init__(
        ...
        self.name = name or 'class_all_binary_accuracy'
...
class OneHotClassBinaryAccuracy(ClassBinaryAccuracy):
    def __init__(
            self,
            class_weights=None,
            class_indexes=None,
        ...
        self.name = name or 'class_all_binary_accuracy_1H'
        super().__init__(
